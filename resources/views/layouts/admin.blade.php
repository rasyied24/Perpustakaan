            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header"><b>{{ get_total_lewat()->count() }} Anggota
                                melebihi batas
                                pengembalian</b></span>
                        <div class="dropdown-divider"></div>
                        @foreach (get_total_lewat() as $value)
                            <a href="{{ url('peminjaman') }}" class="dropdown-item">
                                <i class="fas fa-exclamation-triangle mr-2 text-danger"></i>
                                {{ $value->name }}
                                <span class="float-right text-muted text-sm">{{ $value['telat_balik'] }} hari</span>
                            </a>
                        @endforeach
                    </div>
                </li>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('pengarang') }}"
                                        class="nav-link {{ request()->is('pengarang') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Pengarang
                                        </p>
